<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Nueva tarea</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Define la tarea y asigna responsable</p>
            </div>
            ...
            <div class="overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-100 dark:bg-gray-800 dark:ring-gray-700">
                <form method="POST" action="{{ route('tasks.store') }}" class="space-y-6 p-6">
                    ...
                    <div class="flex items-center justify-end gap-3 border-t border-gray-100 pt-4 dark:border-gray-700">
                        ...
                        <button type="submit" class="inline-flex items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white shadow hover:bg-indigo-700">Guardar tarea</button>
                    </div>
                </form>
            </div>
        </div>
